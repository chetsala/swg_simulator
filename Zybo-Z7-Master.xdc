...
set_property -dict { PACKAGE_PIN K14   IOSTANDARD LVCMOS33 } [get_ports { BTN[4] }]; #IO_L20P_T3_AD6P_35 Sch=btn[4]
...
set_property -dict { PACKAGE_PIN Y11   IOSTANDARD LVCMOS33 } [get_ports { LED5[2] }]; #IO_L18N_T2_13 Sch=led5_r
set_property -dict { PACKAGE_PIN T5    IOSTANDARD LVCMOS33 } [get_ports { LED5[1] }]; #IO_L19P_T3_13 Sch=led5_g
set_property -dict { PACKAGE_PIN Y12   IOSTANDARD LVCMOS33 } [get_ports { LED5[0] }]; #IO_L20P_T3_13 Sch=led5_b

##RGB LED 6
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { LED6[2] }]; #IO_L18P_T2_34 Sch=led6_r
set_property -dict { PACKAGE_PIN F17   IOSTANDARD LVCMOS33 } [get_ports { LED6[1] }]; #IO_L6N_T0_VREF_35 Sch=led6_g
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { LED6[0] }]; #IO_L8P_T1_AD10P_35 Sch=led6_b
...
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33     } [get_ports { ssd_display[6] }]; #IO_L15P_T2_DQS_13 Sch=jb_p[1]		 
set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33     } [get_ports { c }]; #IO_L15N_T2_DQS_13 Sch=jb_n[1]         
...
set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33     } [get_ports { ssd_display[4] }]; #IO_L8P_T1_34 Sch=jc_p[3]              
set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33     } [get_ports { ssd_display[5] }]; #IO_L8N_T1_34 Sch=jc_n[3]              
